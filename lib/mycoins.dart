              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    RoundEdgedButton(
                      ...
                      onTap: () async {
                        ...
                        String conversionRate =
                            await Webservices.getLiveConversionRateBTCToUSD();
                                        ...
                                        Expanded(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                ParagraphText(
                                                  text:
                                                      '≈${oneBtcToJIN.toStringAsFixed(2)} JIN',
                                                  color: MyColors.black54Color,
                                                ),
                                              ],
                                            )),
                    ...
                    //     await inAppServices
                    //         .getInAppPurchaseRequirements('ios.test.purchased');
                    //     await inAppServices.initData();
                    //     await inAppServices.payAndDownload(context);
                    //     print('my namne is prasoon---------');
                    //     setState(() {
                    //       load = false;
                    //     });
                    ...
                    RoundEdgedButton(
                      ...
                      onTap: () async {
                        ...
                        await inAppServices
                            .getInAppPurchaseRequirements('05182806');
